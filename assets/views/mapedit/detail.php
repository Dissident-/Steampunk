	...
	<div class="ui-corner-bottom ui-widget-content padding-10">
		...
		<p>Use default description? <input type="checkbox" name="UseDefaultDesc" value="1" <?php if(!$selected->loaded() || $selected->Description == null || $selected->UseDefaultDesc == 1) echo 'checked="checked"'; ?> /></p>
